...
def play(params, task, max_time):
    ...
    for t in range(max_time):
        ...
        if a in str_to_action and str_to_action[a] in acts:
            ...
            print("Reward: ",reward)#debugging to see if I understand task 3
            print("State: ",u2)
...
if __name__ == '__main__':
    task = int(input("What task (enter 6 for t6) would you like?"))
    map = "../../experiments/craft/maps/map_0.map"
    tasks = ["../../experiments/craft/reward_machines/t%d.txt"%i for i in [task]]
    max_time = 100
